...
class CategoriesGrid extends Grid implements CategoriesGridInterface
{
    /**
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('categories.index');

        // crud support
        $this->setCreateRouteName('categories.create');
        $this->setViewRouteName('categories.show');
        $this->setDeleteRouteName('categories.destroy');
