...
class AdvertisesGrid extends Grid implements AdvertisesGridInterface
{
    /**
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('advertises.index');

        // crud support
        $this->setCreateRouteName('advertises.create');
        $this->setViewRouteName('advertises.show');
        $this->setDeleteRouteName('advertises.destroy');
