<nav style="background-color: #6351ce;" class="navbar navbar-expand-lg ">
    ...
    <a class="text-light navbar-brand" href="#">Navbar</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="text-light nav-link" href="#">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="text-light nav-link disabled" href="#">Disabled</a>
            </li>
        </ul>
