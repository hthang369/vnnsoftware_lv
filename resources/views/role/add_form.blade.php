            ...
            <form method="POST">
                ...
                <div class="form-group required">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="Name"
                           name="name"
                           value="{!! request()->id ? (old('name') ? old('name') : $role->name) : old('name') !!}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('role_rank')
                        is-invalid @enderror" type="text"
                           ...
                           value="{!! request()->id ? (old('role_rank') ? old('role_rank') : $role->role_rank) : old('role_rank') !!}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('description') is-invalid @enderror" type="text"
                           ...
                           value="{!! request()->id ? (old('description') ? old('description') : $role->description) : old('description')!!}"
