...
Route::group(['prefix' => 'system-admin', 'middleware' => ['auth']], function () {
    ...
    // version route
    Route::get('deploy/{environment}', 'Deploy\DeployController@index')->name('Deploy.Deploy index');
    Route::post('deploy/{environment}', 'Deploy\DeployController@doDeploy')->name('Deploy.Deploy doDeploy');
    ...
    Route::group(['prefix' => 'user-management-for-app-chat'], function () {
        ...
        Route::get('add-contact', 'ApprovalApiToken\ApprovalApiTokenController@addContactList')->name('LAKA user manage.LAKA User add company');
        Route::get('add-contact/update/{id}', 'ApprovalApiToken\ApprovalApiTokenController@addContactUpdatePage')->name('LAKA user manage.LAKA User add company update');
        Route::post('add-contact/update/{id}', 'ApprovalApiToken\ApprovalApiTokenController@addContactsAndRoomsByCompany')->name('LAKA user manage.LAKA User add company update');
